...
const patchNotes = [
    {
        "version": "2.0.1",
        "title": "\"Листай, не нажимай\": исправлен баг с \"липкими\" пальцами!",
        "changes": [
            "Исправлена досадная ошибка на мобильных устройствах, из-за которой любое касание для прокрутки могло случайно расцениваться как нажатие, если отпустить палец на карточке кошки или документе.",
            "Теперь приложение умнее и понимает, когда вы хотите просто пролистать страницу, а когда — намеренно нажать на элемент. Больше никаких случайных переходов!",
            "Улучшена общая отзывчивость интерфейса при работе с сенсорным экраном.",
            "Изменена иконка приложения",
            "Боковое меню перенесено вниз экрана для удобной навигации"
        ]
    },
    {
    "version": "2.0.0",
